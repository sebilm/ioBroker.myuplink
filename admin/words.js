...
systemDictionary = {
    ...
    'Use Authorization Code Grant Flow': {
        en: 'Use Authorization Code Grant Flow',
        de: 'Authorization Code Grant Flow verwenden',
        ru: 'Используйте Authorization Code Grant Flow',
        pt: 'Utilizar Authorization Code Grant Flow',
        nl: 'Authorization Code Grant Flow gebruiken',
        fr: 'Utiliser Authorization Code Grant Flow',
        it: 'Utilizzare Authorization Code Grant Flow',
        es: 'Utilizar Authorization Code Grant Flow',
        pl: 'Użyj ACG Authorization Code Grant Flow',
        uk: 'Використовуйте Authorization Code Grant Flow',
        'zh-cn': '使用 Authorization Code Grant Flow',
    },
    'These and the following options are not required in most cases.': {
        en: 'These and the following options are not required in most cases.',
        de: 'Diese und die folgenden Optionen werden in den meisten Fällen nicht benötigt.',
        ru: 'Этот и следующие параметры в большинстве случаев не требуются.',
        pt: 'Esta e as seguintes opções não são necessárias na maioria dos casos.',
        nl: 'Deze en de volgende opties zijn in de meeste gevallen niet nodig.',
        fr: 'Cette option et les suivantes ne sont pas nécessaires dans la plupart des cas.',
        it: 'Questa e le opzioni seguenti non sono necessarie nella maggior parte dei casi.',
        es: 'Esta opción y las siguientes no son necesarias en la mayoría de los casos.',
        pl: 'Ta i poniższe opcje nie są wymagane w większości przypadków.',
        uk: "Ця та наступні опції не є обов'язковими в більшості випадків.",
        'zh-cn': '大多数情况下不需要此选项和以下选项。',
    },
